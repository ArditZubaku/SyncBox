...
public abstract class BaseController {
  ...
  public BaseController(EmailProcessor emailProcessor,
  ...
  public EmailProcessor getEmailProcessor() { return emailProcessor; }

  public void setEmailProcessor(EmailProcessor emailProcessor) {
    this.emailProcessor = emailProcessor;
  }

  public ViewProcessor getViewProcessor() { return viewProcessor; }
  ...
  public void setFxmlName(String fxmlName) { this.fxmlName = fxmlName; }
}
