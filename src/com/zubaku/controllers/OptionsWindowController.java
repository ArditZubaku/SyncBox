...
public class OptionsWindowController
  ...
  @FXML private Slider fontSizePicker;

  @FXML private ChoiceBox<ColorTheme> themePicker;

  public OptionsWindowController(EmailProcessor emailProcessor,
  ...
  void applyButtonAction() {
    ...
    // Get the font size
    viewProcessor.setFontSize(
        FontSize.values()[(int)fontSizePicker.getValue()]);
    // Update CSS styles
  ...
  private void setupThemePicker() {
    themePicker.setItems(
        FXCollections.observableArrayList(ColorTheme.values()));
    // Default value:
