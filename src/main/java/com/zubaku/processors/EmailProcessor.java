...
public class EmailProcessor {
  private static final Logger LOGGER = Logger.getLogger(FolderUpdaterService.class.getName());
  ...
  public EmailProcessor() {
    FolderUpdaterService folderUpdaterService = new FolderUpdaterService(foldersList);
    folderUpdaterService.start();
  }

  public EmailMessage getSelectedEmailMessage() {
    return selectedEmailMessage;
  }
