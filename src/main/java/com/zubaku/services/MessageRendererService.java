...
public class MessageRendererService extends Service<Void> {
  private static final Logger LOGGER = Logger.getLogger(MessageRendererService.class.getName());
  ...
  private void loadMultipartContent(Multipart multipart, StringBuffer stringBuffer)
